...
export const getConfirmationEmailTemplate = (userName: string, date: string, time: string) => {
  return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
        ...
        <div class="container" style="max-width: 600px; margin: 20px auto; background: white; border-radius: 15px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.1);">
            ...
            <div class="header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 40px 30px; text-align: center;">
                <div style="margin-bottom: 15px;">
                    <img src="https://res.cloudinary.com/dvwpxy4kh/image/upload/v1754409963/logoAnimacion2_eksccm.png" alt="Logo" style="width: 80px; height: 80px; border-radius: 50%; background: white; padding: 10px;" />
                </div>
...
export const getCancellationEmailTemplate = (userName: string, date: string, time: string) => {
  return `
    <!DOCTYPE html>
    <html lang="es">
    <head>
